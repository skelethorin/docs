...
[Website](https://www.availproject.org/) <Icon icon="arrow-up-right" />| [Twitter](https://x.com/AvailProject) <Icon icon="arrow-up-right" /> | [Github](https://github.com/availproject) <Icon icon="arrow-up-right" /> | [Resource](https://blog.availproject.org/) <Icon icon="arrow-up-right" />
...
<AccordionGroup>
  ...
  <Accordion title="How do I stake with Krews on Avail?">
    ...
    6. Once the next era is reached, your stake becomes active, and you start earning rewards (minus our 5 % commission). |\
       | **How can I claim and restake rewards?** | You may claim rewards manually via the Staking Dashboard by clicking “Withdraw Rewards” under your account’s staking page. To compound your yield, use the “Bond Extra” function to re-delegate the claimed AVAIL in a single transaction. Krews does not currently offer an auto-restake (REstake) service on Avail; all restaking must be performed manually. |
