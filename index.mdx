...
<Card title="Story Dashboard" icon="https://cloudflare-snapshots.krews.xyz/story.png" iconType="solid" href="/networks/story">
  Live Story Protocol validator analytics, uptime tracking, missed-signature insights and full snapshot services.
</Card>

<Card title="Sunrise Dashboard" icon="https://cloudflare-snapshots.krews.xyz/sunrise.png" iconType="solid" href="/networks/story">
  Specialized tools and monitoring services for Sunrise Network, including uptime, node health and validator analytics.
</Card>

<Card title="Sunrise Explorer" icon="https://cloudflare-snapshots.krews.xyz/sunrise.png" iconType="solid" href="/networks/story">
